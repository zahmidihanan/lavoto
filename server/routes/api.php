...
// Public company info
Route::get('/company', [PublicBookingController::class, 'companyDefault']);
...
// SSE stream (auth via query param — EventSource cannot set Authorization header)
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/bookings/fully-booked-dates',          [BookingController::class, 'fullyBookedDates']);
    ...
    Route::get('/payments/export/word',          [PaymentController::class, 'exportWord']);
